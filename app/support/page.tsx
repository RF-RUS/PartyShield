...
import { TELEGRAM_SUPPORT_GROUP_URL } from '@/lib/constants'

const videoTutorials = [
  {
    titleRu: 'Получение пробной подписки, пошаговая настройка',
    titleEn: 'Getting a trial subscription, step-by-step setup',
    platform: 'RuTube',
    url: 'https://rutube.ru/shorts/a208937b190a7821a07e12323b85d189',
  },
  {
    titleRu: 'Как поделиться подпиской с семьёй?',
    titleEn: 'How to share your subscription with family?',
    platform: 'RuTube',
    url: 'https://rutube.ru/shorts/1908113e5fcf3a99f85126c5c6e6683e/',
  },
  {
    titleRu: 'Как поделиться реферальной ссылкой?',
    titleEn: 'How to share a referral link?',
    platform: 'RuTube',
    url: 'https://rutube.ru/shorts/33a152b90dbde637b842a941016d5450/',
  },
  {
    titleRu: 'Как обновить настройки подписки?',
    titleEn: 'How to update subscription settings?',
    platform: 'RuTube',
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="glass p-8 rounded-xl card-hover anim-fade-up delay-1">
              ...
              <p className="text-gray-400 mb-6">
                {t.support.telegram.desc}
              </p>
              <a
                href={TELEGRAM_SUPPORT_GROUP_URL}
                target="_blank"
          ...
          <div className="mb-16">
            <div className="text-center mb-8 anim-fade-up delay-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
              {videoTutorials.map((video, index) => {
                ...
                const title = lang === 'ru' ? video.titleRu : video.titleEn
                return (
                  <div
                    key={index}
                    className={`glass p-6 rounded-xl card-hover anim-fade-up delay-${Math.min(index + 3, 8)}`}
                  >
                      ...
                      {embedUrl ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          ...
                          >
                            ...
                            <span className="text-sm text-gray-400">{t.support.openVideo}</span>
                          </a>
                        </div>
                      )}
                    </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8 anim-fade-up delay-4">
            ...
            <div className="space-y-4">
              {faqItems.map((item, index) => (
                <div
                  key={index}
                  className={`glass rounded-xl overflow-hidden anim-fade-up delay-${Math.min(index + 5, 8)}`}
                >
                  <button
